export default function reducer(state={
    ...
    eyes:{
      ...
      rightEye :      {artId: 'eye02', id:'rightEye', useEyeBall: true, eyeBallId:'eyeBall', bgColor:'white',useLids:false,useMask:true,w:60,h:60,bx:'62%',by:'42%',brx:0,bry:180,brz:0,cx:'70%',cy:'30%'},
